...
<button onclick="myFunction()" class="dropbtn">Cuisines</button>
 ...
 <li><a href="http://localhost/project/contact.php">Contact</a></li>
  <li><a href="http://localhost/project/order.php">Order</a></li>
  <li style="float:right"><a href="http://localhost/project/frontuser.php">User</a></li>
  <li style="float:right"><a href="http://localhost/project/frontadmin.php">Admin</a></li>
  </ul>
